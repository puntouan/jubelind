...
import com.jubel.jubelind.recipes.infrastructure.dtos.MacroDataDtoMapper
...
class GetRecipeMacroDataByIdController @Inject constructor(
    private val getRecipeById: GetRecipeById,
    private val macroDataDtoMapper: MacroDataDtoMapper
) {

    init {
        get("/recipe/:recipeId/macro-data"){
    ...
    fun getRecipeById(recipeId: String): Any{
        ...
        return Json.encodeToString(
            macroDataDtoMapper.mapRecipeToMacroDataDto(recipe)
        )
    }
